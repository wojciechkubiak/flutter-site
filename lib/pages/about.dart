                  ...
                  children: [
                    Container(
                      margin: EdgeInsets.only(
                          top: height < 600 ? 120 : 70, bottom: 20),
                      child: Text(
                        'Find out more',
                        style: TextStyle(
                          fontSize: 82,
...
If you want to hire me or give me an assignment, so I can share my passion with you, fill in the form at the end of the website or just go into one of my social medias and message me. If you want to get to know me better, click''',
                            style: TextStyle(
                              fontSize: 24,
                              color: Colors.white,
                              fontFamily: 'Raleway',
